...
input int    Signal_MA_PeriodMA =
  24;                           // Moving Average(24,0,...) Period of averaging
input int Signal_MA_Shift = 0;  // Moving Average(24,0,...) Time shift
input ENUM_MA_METHOD Signal_MA_Method =
  MODE_SMA;  // Moving Average(24,0,...) Method of averaging
input ENUM_APPLIED_PRICE Signal_MA_Applied =
  PRICE_CLOSE;  // Moving Average(24,0,...) Prices series
input double Signal_MA_Weight =
  1.0;  // Moving Average(24,0,...) Weight [0...1.0]
//--- inputs for trailing
